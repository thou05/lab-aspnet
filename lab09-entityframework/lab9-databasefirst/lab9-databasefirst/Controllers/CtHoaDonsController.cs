...
namespace lab9_databasefirst.Controllers
{
    ...
    {
        private readonly Lab09shopingcartContext _context;

        public CtHoaDonsController(Lab09shopingcartContext context)
        {
            _context = context;
        }
        ...
        {
            var lab09shopingcartContext = _context.CtHoaDons.Include(c => c.HoaDon).Include(c => c.SanPham);
            return View(await lab09shopingcartContext.ToListAsync());
        }
        ...
        public IActionResult Create()
        {
            ...
            ViewData["SanPhamId"] = new SelectList(_context.SanPhams, "MaSanPham", "MaSanPham");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,HoaDonId,SanPhamId,SoLuongMua,DonGiaMua,ThanhTien,TrangThai")] CtHoaDon ctHoaDon)
        {
            ...
            ViewData["HoaDonId"] = new SelectList(_context.HoaDons, "MaHoaDon", "MaHoaDon", ctHoaDon.HoaDonId);
            ViewData["SanPhamId"] = new SelectList(_context.SanPhams, "MaSanPham", "MaSanPham", ctHoaDon.SanPhamId);
            return View(ctHoaDon);
        }
